<template lang="">
  <div :class="!application.sidebarCollapse? 'sidebar open':'sidebar closed'">
    ...
    <div class="shortcuts">
      ...
      <router-link :to="{name:'assets'}" class="shortcut"><i class="i-pie-chart"></i><span>Assets</span></router-link>
