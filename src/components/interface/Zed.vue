<template lang="">
<svg width="100%" height="100%" class="logo-svg animated" viewBox="0 0 833 790" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:bevel;stroke-miterlimit:1.5;">
...
export default {
  ...
  name: 'Zed',
  mounted() {
    document.querySelector(".logo-svg.animated").addEventListener("mouseenter", () => {
      document.querySelector(".logo-svg").classList.remove("animated")
      setTimeout(() => {
