<template lang="">
  ...
  <!-- <a href="/" class="logo"><img alt="Vue logo" src="../../assets/img/logo-yellow-stroke.png"> The Valuator Machine</a> -->
  ...
  <a title="Toggle sidebar" class="btn-link" @click.stop="toggleSidebarCollapse(!application.sidebarCollapse)">
    <i :class="application.sidebarCollapse?'duotone icon-angle-double-right':'duotone icon-angle-double-left'"></i>
  </a>
  ...
  <div class="nav-links">
    ...
    <div class="menu" v-if="menu">
      <ul>
        ...
        <li>
          <router-link :to="{ name: 'Settings'}"><i class="duotone icon-equalizer"></i><span>Settings</span></router-link>
        </li>
